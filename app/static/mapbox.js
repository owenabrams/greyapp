...
L.mapbox.accessToken = 'pk.eyJ1Ijoib3dlbmFicmFtcyIsImEiOiJjajJjZXlraGcwMDBrMndtdWJ6NDFsNWt4In0.AGrAM2loGsdGl04TQiGRnw';
...
// ================================================================================
//  Initializing the patient layer and popups
// ================================================================================

// load the initial patient set into a featureLayer from geojson for display
var initialPatientLayer = L.mapbox.featureLayer().addTo(map);
initialPatientLayer.loadURL('/initial_patients.geojson');

initialPatientkLayer.on('layeradd', function(e) {
  var marker = e.layer,
...
// load the patient markers into a featureLayer from geojson, but don't add to map
var patientLayer = L.mapbox.featureLayer();
patientLayer.loadURL('/patients.geojson');
initialPatientLayer.once('click', function(e) {
    map.setView(e.latlng, 14);
    map.panTo(e.latlng);
    patientLayer.addTo(map);
    map.removeLayer(initialPatientLayer);
  });

// create popups for landmarks
patientLayer.on('layeradd', function(e) {
...
patientLayer.on('click', function(e) {
    e.layer.openPopup();
});
